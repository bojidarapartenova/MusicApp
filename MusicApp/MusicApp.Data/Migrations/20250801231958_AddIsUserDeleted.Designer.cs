...
namespace MusicApp.Data.Migrations
{
    ...
    [Migration("20250801231958_AddIsUserDeleted")]
    partial class AddIsUserDeleted
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MusicApp.Data.Models.Notification", b =>
                {
                    b.HasOne("MusicApp.Data.Models.ApplicationUser", "Author")
                        .WithMany()
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("MusicApp.Data.Models.Comment", "Comment")
                        .WithMany()
